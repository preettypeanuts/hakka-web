...
export const ServiceCTA = () => {
    return (
        <section className="margin spacing">
            <div className="relative rounded-2xl overflow-hidden bg-mainColor px-8 py-16 md:px-16 md:py-20">
                ...
                <div className="relative z-10 max-w-2xl">
                    ...
                    <p className="text-white/70 text-base leading-relaxed mb-8 max-w-lg">
                        Our logistics team is ready to assess your shipment requirements and
                        recommend the most efficient solution — at no cost.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-3">
                        <Link
                            href="/contact"
                            className="inline-flex items-center gap-2 bg-white text-mainColor text-sm font-semibold px-6 py-3 rounded-xl hover:bg-neutral-100 transition"
                        >
                            Talk to Our Team
                            <span>→</span>
                        </Link>
                        <Link
                            ...
                            className="inline-flex items-center gap-2 border border-white/30 text-white text-sm font-semibold px-6 py-3 rounded-xl hover:bg-white/10 transition"
                        >
                            {/* WhatsApp icon */}
                            <svg
